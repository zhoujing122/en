...
struct Config {
    ...
    bool stop_go_mapping_enabled = false;
    double stop_go_forward_step_mm = 20.0;
    int stop_go_max_steps = 20;
    double stop_go_max_total_distance_mm = 400.0;
    double stop_go_motion_max_rpm = 12.0;
    int stop_go_motion_timeout_ms = 3000;
    double stop_go_settle_wheel_rpm_threshold = 1.0;
    double stop_go_settle_imu_gyro_threshold_deg_s = 1.0;
    int stop_go_settle_consecutive_frames = 3;
    int stop_go_settle_hold_ms = 200;
    int stop_go_tof_samples_per_sensor = 5;
    int stop_go_tof_min_valid_samples = 3;
    int stop_go_tof_protocol_min_distance_mm = 20;
    int stop_go_tof_protocol_max_distance_mm = 4500;
    int stop_go_tof_mapping_min_distance_mm = 30;
    ...
    int sparse_slam_active_bundle_max_snapshots = 64;
    int sparse_slam_active_bundle_max_rays = 192;
    double sparse_slam_active_bundle_max_duration_s = 8.0;
    double sparse_slam_active_bundle_max_snapshot_gap_s = 0.50;
    int sparse_slam_active_bundle_min_snapshots = 2;
    ...
    std::string sparse_slam_local_match_mode = "yaw_only";
    double sparse_slam_local_match_max_abs_yaw_rad = 0.2617993877991494;
    double sparse_slam_local_match_coarse_yaw_step_rad = 0.03490658503988659;
    double sparse_slam_local_match_fine_yaw_step_rad = 0.008726646259971648;
    double sparse_slam_local_match_max_abs_translation_x_m = 0.0;
    double sparse_slam_local_match_max_abs_translation_y_m = 0.0;
    int sparse_slam_local_match_max_candidate_count = 256;
    int sparse_slam_local_match_max_coarse_candidates = 64;
    int sparse_slam_local_match_max_fine_candidates = 64;
    int sparse_slam_local_match_max_total_candidates = 128;
    int sparse_slam_local_match_max_scored_rays = 96;
    int sparse_slam_local_match_max_cells_per_ray = 256;
    int sparse_slam_local_match_min_bundle_frames = 2;
    int sparse_slam_local_match_min_matchable_rays = 3;
    int sparse_slam_local_match_min_reference_cells = 1;
    int sparse_slam_local_match_min_reference_occupied_cells = 1;
    int sparse_slam_local_match_min_reference_free_cells = 0;
    double sparse_slam_local_match_no_return_free_space_range_m = 12.0;
    int sparse_slam_local_match_min_used_rays = 3;
    int sparse_slam_local_match_min_known_cells = 6;
    double sparse_slam_local_match_max_unknown_ratio = 0.85;
    double sparse_slam_local_match_max_contradiction_ratio = 0.60;
    double sparse_slam_local_match_min_normalized_score = 0.02;
    double sparse_slam_local_match_min_score_margin = 0.03;
    double sparse_slam_local_match_min_score_range = 0.02;
    double sparse_slam_local_match_runner_up_exclusion_yaw_rad = 0.03490658503988659;
    double sparse_slam_local_match_multimodal_max_score_drop = 0.04;
    double sparse_slam_local_match_free_agreement_weight = 1.0;
    double sparse_slam_local_match_free_contradiction_weight = -3.0;
    double sparse_slam_local_match_occupied_endpoint_agreement_weight = 4.0;
    ...
    int sparse_slam_relocalization_coarse_max_scored_rays = 32;
    int sparse_slam_relocalization_refine_max_scored_rays = 96;
    int sparse_slam_relocalization_max_cells_per_ray = 256;
    int sparse_slam_relocalization_top_k = 8;
    int sparse_slam_relocalization_max_total_candidates = 15000;
    int sparse_slam_relocalization_coarse_free_cell_stride = 4;
    double sparse_slam_relocalization_coarse_yaw_step_rad = 0.2617993877991494;
    double sparse_slam_relocalization_refine_xy_step_m = 0.10;
    double sparse_slam_relocalization_refine_yaw_step_rad = 0.05235987755982989;
    double sparse_slam_relocalization_final_xy_step_m = 0.05;
    double sparse_slam_relocalization_final_yaw_step_rad = 0.017453292519943295;
    double sparse_slam_relocalization_local_xy_half_range_m = 0.40;
    double sparse_slam_relocalization_local_yaw_half_range_rad = 0.5235987755982988;
    double sparse_slam_relocalization_exclusion_xy_m = 0.25;
    double sparse_slam_relocalization_exclusion_yaw_rad = 0.2617993877991494;
    double sparse_slam_relocalization_min_normalized_score = 0.02;
    double sparse_slam_relocalization_min_score_margin = 0.02;
    double sparse_slam_relocalization_min_score_range = 0.015;
    double sparse_slam_relocalization_multimodal_max_score_drop = 0.03;
    ...
    double exploration_min_x_m = -1.5;
    double exploration_max_x_m = 1.5;
    double exploration_min_y_m = -1.0;
    double exploration_max_y_m = 1.0;
    double exploration_robot_radius_m = 0.08;
    double exploration_safety_margin_m = 0.04;
    int exploration_maximum_navigation_cells = 200000;
    int exploration_minimum_frontier_cluster_cells = 2;
    double exploration_information_gain_weight = 0.02;
    int exploration_maximum_astar_nodes = 50000;
    int exploration_no_frontier_confirmation_cycles = 3;
    ...
    double exploration_minimum_goal_distance_m = 0.30;
    int exploration_failure_memory_capacity = 64;
    int exploration_failure_cooldown_cycles = 2;
    int exploration_maximum_goal_failures = 3;
    int exploration_failure_retry_revision_delta = 20;
    double exploration_waypoint_tolerance_m = 0.10;
    double exploration_yaw_tolerance_rad = 0.10;
    double exploration_minimum_progress_m = 0.01;
    double exploration_no_progress_timeout_s = 4.0;
    int exploration_maximum_segments_without_progress = 8;
    double exploration_obstacle_stop_distance_m = 0.22;
    double exploration_emergency_stop_distance_m = 0.10;
    int exploration_obstacle_confirmation_frames = 2;

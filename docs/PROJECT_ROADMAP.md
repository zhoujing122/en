...
- M3-D1: current stage. Add Invalid / Hit / NoReturn scalar ToF semantics and the lightweight sparse three-ToF occupancy backend.
- M3-D2: next stage. Add sparse scan matching, pose correction, and keyframes.

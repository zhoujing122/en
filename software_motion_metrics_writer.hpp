...
inline void write_software_motion_metrics(std::ostream &o, const RunMetrics &m, const Config &cfg) {
    o << "motion_writer_backend," << (cfg.motion_execution_writer_backend == "software_direction_speed_test_only" ? 1 : 0) << "\n";

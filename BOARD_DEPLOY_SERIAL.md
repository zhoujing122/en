...
```sh
Projects/rv1126b-dev/serial_chunk_push.py \
  Projects/rv1126b-dev/robot_slamd/config.board_sim_spin_scan_smoke.yaml \
  /userdata/robot_slamd/config.board_sim_spin_scan_smoke.yaml \
  --port /dev/ttyUSB0 \
  --baud 1500000 \
  --chunk-size 1024 \
  --line-chars 128 \
...
```sh
Projects/rv1126b-dev/serial_cmd.py \
  "/userdata/robot_slamd/robot_slamd --config /userdata/robot_slamd/config.board_sim_spin_scan_smoke.yaml --duration-s 20 --output-dir /userdata/robot_slamd_board_sim_spin_scan_smoke" \
  --port /dev/ttyUSB0 \
  --baud 1500000 \
  --timeout 35
```
...
```sh
Projects/rv1126b-dev/serial_cmd.py \
  "sh /userdata/robot_slamd/tools/board_runtime_profile_smoke.sh /userdata/robot_slamd/robot_slamd /userdata/robot_slamd/config.board_sim_spin_scan_smoke.yaml /userdata/robot_slamd_board_runtime_profile_smoke 20" \
  --port /dev/ttyUSB0 \
  --baud 1500000 \
  --timeout 45
```

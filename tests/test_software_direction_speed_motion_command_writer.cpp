...
#include "robot_slamd/software_motion/software_direction_speed_motion_command_writer.hpp"
...
void static_safety_search() {
    ...
    const std::vector<std::string> production = {
        dir + "include/robot_slamd/software_motion/software_motion_command.hpp",
        dir + "include/robot_slamd/software_motion/software_motion_transport.hpp",
        dir + "include/robot_slamd/software_motion/loopback_software_motion_transport.hpp",
        dir + "include/robot_slamd/software_motion/software_direction_speed_motion_command_writer.hpp",

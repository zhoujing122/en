...
inline robot_slamd::Config p5_single_corner_test_config() {
    ...
    c.stop_go_mapping_mode = "single_corner";
    c.stop_go_forward_step_mm = 20.0;
    c.stop_go_max_steps = 80;
    c.stop_go_max_total_distance_mm = 1600.0;
    ...
    c.stop_go_corner_post_corner_required_follow_steps = 5;
    ...
    c.sparse_slam_map_run_id = "formal_p5_single_corner";
    return c;
}
